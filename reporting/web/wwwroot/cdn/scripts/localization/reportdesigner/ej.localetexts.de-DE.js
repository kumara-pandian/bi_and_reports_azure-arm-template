ej.ReportDesigner.Locale['de-DE'] = {
    itemPanel: {
        ...
        labelText: 'Artikel Panel Container',
        expandText: 'Erweitern',
        collapseText: 'Zusammenbruch',
        customTooltip: {
            tooltip: {
        ...
        groupItems: {
                ...
                Items: {
                    ...
                    'textBox': {
                        ...
                        tooltip: {
                            ...
                            description: 'Zeigt statischen und dynamischen Text an.',
                            title: 'Textfeld'
                        }
                    },
                    'rectangle': {
            ...
            comparison: {
                ...
                Items: {
                    ...
                    'rangeColumn': {
                        displayText: 'Bereichsspalte',
                        tooltip: {
                            requirements: '1 oder mehr Werte und 1 oder mehr Spalten.',
                            description: 'Zeigt einen Datenbereich an, indem zwei Y-Werte pro Datenpunkt gezeichnet werden',
                            title: 'Bereichsspalte'
                        }
                    },
                    'rangeBar': {
                        displayText: 'Bereichsleiste',
                        tooltip: {
                            requirements: '1 oder mehr Werte und 1 oder mehr Spalten.',
                            description: 'Zeigt einen Datenbereich an, indem zwei Y-Werte pro Datenpunkt horizontal dargestellt werden',
                            title: 'Bereichsleiste'
                        }
                    },
            ...
            kpi: {
                ...
                Items: {
                    ...
                    'indicator': {
                        ...
                        tooltip: {
                            requirements: '1 Wert.',
                            description: 'Minimale Darstellung von Anzeigen, die den Status einzelner Daten darstellen.',
                            title: 'Indikator'
                        }
                    }
                }
            ...
            gauge: {
                groupName: 'Abweichung',
                Items: {
                    'radialgauge': {
                        displayText: 'Radiallehre',
                        tooltip: {
                            requirements: '1 Wert und 0 oder 1 Start- / Endwert.',
                            description: 'Visualisieren Sie Trends anhand von Leistungsindikatoren wie Werten und Zielen.',
                            title: 'Radiallehre'
                        }
                    },
                    'lineargauge': {
                        displayText: 'Lineares Messgerät',
                        tooltip: {
                            requirements: '1 Wert und 0 oder 1 Start- / Endwert.',
                            description: 'Visualisieren Sie Trends anhand von Leistungsindikatoren wie Werten und Zielen. Wird häufig in Tabellen und Matrizen verwendet.',
                            title: 'Lineares Messgerät'
                        }
                    }
                }
            },
            ...
            distribution: {
                ...
                Items: {
                    ...
                    'rangeArea': {
                        ...
                        tooltip: {
                            requirements: '1 oder mehr Werte und 1 oder mehr Spalten.',
                            description: 'Eine Art Flächendiagramm, bei dem die Fläche nicht auf der Achse beginnt, sondern durch den Abstand zwischen zwei Werten dargestellt wird.',
                            title: 'Bereich'
                        }
                    },
                    'smoothRangeArea': {
                        displayText: 'Glatter Bereich',
                        tooltip: {
                            requirements: '1 oder mehr Werte und 1 oder mehr Spalten.',
                            description: 'Gekrümmte Linien zum Verbinden von Datenpunkten anstelle von geraden.',
                            title: 'Glatter Bereich'
                        }
                    }
                }
            },
                ...
                Items: {
                    'tablix': {
                        ...
                        tooltip: {
                            ...
                            description: 'Zeigen Sie die paginierten Daten in Tabellenform an.',
                            title: 'Tabelle'
                        }
                    },
                    'list': {
                    ...
                    'matrix': {
                        displayText: 'Matrix',
                        tooltip: {
                            requirements: '1 oder mehr Werte und 1 oder mehr Zeilen / Spalten.',
                            description: 'Zeigen Sie zusammengefasste Daten im tabellenübergreifenden Format an.',
                            title: 'Matrix'
                        }
                    }
                }
            ...
            maps: {
                ...
                Items: {
                    'map': {
                        displayText: 'Karte',
                        tooltip: {
                            requirements: 'Zeigen Sie dem Bericht eine Karte an.',
                            description: 'Zeigt Analysedaten vor einem geografischen Hintergrund an.',
                            title: 'Karte'
                        }
                    }
                }
    ...
    linkReport: {
        ...
        labelText: 'Verknüpfen Sie den Unterbericht mit dem Berichtselement',
        reportDialog: 'Öffnen Sie den Berichtsdialog',
        setParameter: 'Setze Parameter',
        dialogHeader: 'Berichts-Designer',
        alertContent: 'Zugriff auf Serverberichte nicht möglich.'
    },
    imageProperty: {
        basicSettings: {
        ...
        appearance: {
            ...
            borderProperties: {
                defaultColor: 'Randfarbe',
                defaultSize: 'Rahmengrösse',
                defaultStyle: 'Rahmenstil',
                leftColor: 'Rahmenfarbe links',
                leftSize: 'Rahmen linke Größe',
                leftStyle: 'Linke Rahmenart',
                topColor: 'Rahmen Top Farbe',
                topSize: 'Rand Top Größe',
                topStyle: 'Rahmen Top Style',
                rightColor: 'Rahmenfarbe rechts',
                rightSize: 'Rand richtige Größe',
                rightStyle: 'Rahmen richtiger Stil',
                bottomColor: 'Rahmenfarbe unten',
                bottomSize: 'Rand unten Größe',
                bottomStyle: 'Rand unten Style'
            }
        },
        size: {
            categoryName: 'Größe',
    ...
    chartProperty: {
        ...
        basicSettings: {
            ...
            chartType: {
                ...
                smoothLineWithMarkers: 'Glatte Linie mit Markern',
                scatter: 'Streuen',
                bubble: 'Blase',
                polar: 'Polar',
                radar: 'Radar',
                rangeArea: 'Bereich',
                rangeColumn: 'Bereichsspalte',
                rangeBar: 'Bereichsleiste',
                smoothRangeArea: 'Glatter Bereich',
                alertSwitchChartType: 'Der gesamte Serientyp wird geändert. Möchtest du fortfahren?'
            },
            legendProperties: {
                booleanPropertyLabel: 'Legende zeigen',
                title: 'Titel',
        ...
        forecast: {
            categoryName: 'Prognoseeinstellungen',
            enableSettings: 'Ermöglichen',
            forecastlength: 'Länge (Punkte)',
            confidenceInterval: 'Konfidenzintervall',
            seasonality: 'Saisonalität (Punkte)',
            enableSeries: 'Vorhersage',
            forecastColor: 'Vorhersage Farbe',
            confidenceEnable: 'Vertrauen',
            confidenceColor: 'Vertrauensfarbe',
            bandStyle: 'Vertrauensband-Stil',
            confidenceBandTypes: {
                fill: 'Füllen',
                linetype: 'Linie',
                dot: 'Punkt',
        ...
        title: {
            categoryName: 'Titel',
            booleanPropertyLabel: 'Diagrammtitel anzeigen',
            label: 'Titeltext',
            position: 'Titelposition'
        },
        axis: {
            booleanPropertyLabel: 'Achse aktivieren',
            title: 'Achsentitel',
            ...
            tickProperties: {
                sizeLabel: 'zecken ​​Größe',
                colorLabel: 'zecken ​​Farbe',
                width: 'Breite',
                length: 'Länge'
            },
            ...
            gridLineProperties: {
                color: 'Rasterlinienfarbe',
                size: 'Rasterliniengröße',
                style: 'Rasterlinienstil'
            },
            chartTicks: {
                length: 'Tick Länge',
                width: 'Tick Breite'
        ...
        gridLine: {
            ...
            style: {
                booleanPropertyLabel: 'Minor Rasterlinie anzeigen',
                major: 'Haupt-Rasterlinie-Stil',
                minor: 'Geringfügiger Rasterlinie-Stil'
            }
        },
        pageBreak: {
            categoryName: 'Seitenumbruch',
            booleanPropertyLabel: 'Seitenumbruch aktivieren',
        ...
        seriesSettings: {
            ...
            basicSettings: {
                ...
                smartLabelProperties: {
                    booleanPropertyLabel: 'SmartLabel aktivieren',
            ...
            link: 'Verknüpfung',
            markerProperties: {
                categoryName: 'Markierungseinstellungen',
                booleanPropertyLabel: 'Markierung zeigen',
                color: 'Farbe',
                typePropertyLabel: 'Markierungstyp',
                types: {
                    square: 'Platz',
                    circle: 'Kreis',
                    diamond: 'Diamant',
            ...
            dataLabelProperties: {
                categoryName: 'Datenbeschriftungseinstellungen',
                booleanPropertyLabel: 'Zeige Datenlabel',
                formatPropertyLabel: 'Format',
                labelPropertyText: 'Etikette',
                valueAsText: 'Wert als Label verwenden',
                types: {
                    valueX: '#VALX',
                    valueY: '#VALY',
                    valueY2: '#VALY2',
        ...
        dataElement: {
            ...
            elementOutput: {
                auto: 'Auto',
                noOutput: 'Keine Leistung',
                categoryName: 'Ausgabe',
                output: 'Ausgabe'
            }
        }
    },
    ...
    gaugeProperty: {
        ...
        labelCategory: {
            ...
            alignmentTypes: {
                ...
                rightAlignment: 'Recht',
                topAlignment: 'oben',
                middleAlignment: 'Mitte',
                bottomAlignment: 'Unterseite'
            },
            textDecoration: 'Dekoration',
            textDecorationTypes: {
    ...
    indicatorProperty: {
        typesCategory: {
            categoryName: 'Anzeigertypen',
            types: {
                threeColoredArrows: 'Drei farbige Pfeile',
                threeGrayArrows: 'Drei graue Pfeile',
                threeUpDownTriangles: 'Drei UpDown-Dreiecke',
                fourGrayArrows: 'Vier graue Pfeile',
                fourColoredArrows: 'Vier farbige Pfeile',
                fiveGrayArrows: 'Fünf graue Pfeile',
                fiveColoredArrows: 'Fünf farbige Pfeile',
                threeCircledSymbols: 'Drei eingekreiste Symbole',
                threeUncircledSymbols: 'Drei nicht eingekreiste Symbole',
                threeFlags: 'Drei Fahnen',
                threeUnrimmedTrafficLights: 'Drei Ampeln ohne Rand',
                threeRimmedTrafficLights: 'Drei umrandete Ampeln',
                threeSigns: 'Drei Zeichen',
                fourTrafficLights: 'Vier Ampeln',
                redToBlack: 'Rot bis schwarz',
                threeStars: 'Drei Sterne',
                fiveStars: 'Fünf Sterne',
                fourRatings: 'Vier Bewertungen',
                fiveRatings: 'Fünf Bewertungen',
                fiveQuarters: 'Fünf Viertel',
                fiveBlocks: 'Fünf Blöcke',
                custom: 'Brauch'
            }
        },
        valueCategory: {
        ...
        states: {
            categoryName: 'Indikatorzustände',
            icons: {
                circle: 'Kreis',
                flag: 'Flagge',
                arrowDown: 'Pfeil nach unten',
                arrowDownIncline: 'Pfeil nach unten neigen',
                arrowSide: 'Pfeilseite',
                arrowUp: 'Pfeil nach oben',
                arrowUpIncline: 'Pfeil nach oben neigen',
                boxesNoneFilled: 'Kästen keine gefüllt',
                boxesOneFilled: 'Kästen eins gefüllt',
                boxesTwoFilled: 'Boxen zwei gefüllt',
                boxesThreeFilled: 'Boxen drei gefüllt',
                boxesAllFilled: 'Kästen alle gefüllt',
                quartersNoneFilled: 'Viertel ohne gefüllt',
                quartersOneFilled: 'Viertel eins gefüllt',
                quartersTwoFilled: 'Viertel zwei gefüllt',
                quartersThreeFilled: 'Viertel drei gefüllt',
                quartersAllFilled: 'Viertel alle gefüllt',
                signalMeterNoneFilled: 'Signalanzeige Keine gefüllt',
                signalMeterOneFilled: 'Signal Meter One Gefüllt',
                signalMeterTwoFilled: 'Signalanzeige Zwei gefüllt',
                signalMeterThreeFilled: 'Signalanzeige drei gefüllt',
                signalMeterFourFilled: 'Signalanzeige 4 gefüllt',
                starQuartersNoneFilled: 'Sternviertel Keine gefüllt',
                starQuartersOneFilled: 'Stern Viertel eins gefüllt',
                starQuartersTwoFilled: 'Stern Viertel Zwei Gefüllt',
                starQuartersThreeFilled: 'Stern Viertel Drei Gefüllt',
                starQuartersAllFilled: 'Sternviertel alle gefüllt',
                threeSignsCircle: 'Kreis mit drei Zeichen',
                threeSignsDiamond: 'Drei Zeichen Diamant',
                threeSignsTriangle: 'Dreieck mit drei Zeichen',
                threeSymbolCheck: 'Überprüfung mit drei Symbolen',
                threeSymbolCross: 'Kreuz mit drei Symbolen',
                threeSymbolExclamation: 'Ausruf mit drei Symbolen',
                threeSymbolUnCircledCheck: 'Nicht eingekreiste Prüfung mit drei Symbolen',
                threeSymbolUnCircledCross: 'Nicht eingekreistes Kreuz mit drei Symbolen',
                threeSymbolUnCircledExclamation: 'Drei nicht eingekreiste Ausrufezeichen',
                trafficLight: 'Ampel',
                trafficLightUnrimmed: 'Ampel ohne Rand',
                triangleDash: 'Dreieck Strich',
                triangleDown: 'Dreieck nach unten',
                triangleUp: 'Dreieck oben',
                lightArrowDown: 'Licht Pfeil runter',
                lightArrowDownIncline: 'Leichter Pfeil nach unten neigen',
                lightArrowSide: 'Leichte Pfeilseite',
                lightArrowUp: 'Licht Pfeil nach oben',
                lightArrowUpIncline: 'Leichter Pfeil nach oben neigen',
                buttonStop: 'Schaltfläche Stop',
                buttonPlay: 'Button Spielen',
                buttonPause: 'Taste Pause',
                faceSmile: 'Gesicht Lächeln',
                faceNeutral: 'Gesichtsneutral',
                faceFrown: 'Stirnrunzeln',
                none: 'Keiner'
            }
        },
        miscellaneous: {
    ...
    linearGaugeProperty: {
        scaleCategory: {
            ...
            scaleLabelsCategory: {
                showScaleLabels: 'Etiketten',
                showScaleLabelsAtEnd: 'Labels am Ende anzeigen'
            },
            ticksCategory: {
                tickMark: 'Häkchen setzen',
                majorTick: 'Hauptzecke',
                minorTick: 'Kleine Zecke',
                majorTickPlacement: 'Haupt Tick Platzierung',
                minorTickPlacement: 'Kleinere Tick Platzierung',
            ...
            pointerCategory: {
                pointer: 'Zeiger',
                enablePointer: 'Zeiger aktivieren',
                pointerValue: 'Wert',
                pointerType: 'Art',
                pointerTypes: {
                    marker: 'Marker',
            ...
            rangeCategory: {
                range: 'Angebot',
                enableRange: 'Bereich aktivieren',
                rangeWidth: 'Breite',
                startRange: 'Start',
                endRange: 'Ende',
                startWidth: 'Start',
    ...
    radialGaugeProperty: {
        scaleCategory: {
            ...
            scaleLabelsCategory: {
                showScaleLabels: 'Etiketten',
                showScaleLabelsAtEnd: 'Labels am Ende anzeigen',
                rotateScaleLabels: 'Etiketten drehen'
            },
            ticksCategory: {
                tickMark: 'Häkchen setzen',
                majorTick: 'Hauptzecke',
    ...
    subReportProperty: {
        ...
        noRows: {
            ...
            writingMode: {
                categoryName: 'Schreibmodus',
                default: 'Standard',
                horizontal: 'Horizontal',
                vertical: 'Vertikal',
                rotateProperty: 'Drehen270'
            }
        },
        visibility: {
            categoryName: 'Sichtweite',
    ...
    rectangleProperty: {
        ...
        pageBreak: {
            categoryName: 'Seitenumbruch',
            enableProperty: {
                labelText: 'Seitenumbruch aktivieren',
                breakLocation: {
                    labelText: 'Ort brechen',
                    none: 'Keiner',
                    start: 'Anfang',
                    end: 'Anfang',
                    startAndEnd: 'Start und Ende',
    ...
    browseFile: {
        ...
        alertMessage: {
            ...
            selectCategory: 'Bitte erstellen Sie eine Kategorie',
        },
        warningMessage: {
        ...
        reloadAriaLabelText: 'Nachladen durchsuchen',
        containerAriaLabelText: 'Dateicontainer durchsuchen'
    },
    publishReport: {
        title: 'Als Bericht veröffentlichen',
        publish: 'Veröffentlichen',
        category: 'Kategorie',
        selectCategory: 'Bitte wählen sie eine Kategorie',
        createCategory: 'Kategorie erstellen',
        categoryPermission: 'Aktivieren Sie die Erstellungsberechtigung, um eine neue Kategorie zu erstellen',
        categoryname: 'Name',
        emptyName: 'Bitte geben Sie einen Namen für den Bericht ein',
        invalidName: 'Die folgenden Zeichen werden nicht unterstützt: \ \' +, []% #',
        description: 'Beschreibung',
        maxCharacter: '* Maximal 1024 Zeichen',
        markaspublic: 'Als öffentlich markieren',
        cancel: 'Stornieren',
        ...
        addCategory: {
            ...
            name: 'Name',
            description: 'Beschreibung',
            emptyValidation: 'Bitte geben Sie den Kategorienamen ein',
            duplicateNameValidation: 'Der Artikelname ist bereits vorhanden',
            createActionFailure: 'Kategorie konnte nicht im Server erstellt werden',
            saveLabel: 'speichern'
        },
        warningMessage: {
            sameNameError: 'In der Kategorie ist bereits ein gleichnamiger Bericht vorhanden',
            replaceMessage: '. Möchten Sie es ersetzen?',
            publishAsReport: 'Als Bericht veröffentlichen'
        },
    },
    expressionMenu: {
        reset: 'Zurücksetzen',
    ...
    propertyPanel: {
        ...
        alertMessage: {
            emptyNameValidation: 'Name darf nicht leer sein',
            duplicateNameValidation: 'Name existiert bereits',
            invalidCharacterValidation: 'Name sollte keine Leerzeichen und Sonderzeichen enthalten',
            alertDialogHeader: 'Eigenschaften',
            specialCharacterValidation: 'Der Eigenschaftswert sollte keine Leerzeichen und Sonderzeichen enthalten.'
        },
        unitType: {
            inchText: 'im',
            centimeterText: 'cm',
        ...
        None: 'Keiner',
        propertyEdit: 'Bearbeiten',
        itemCountWaterMark: 'Artikel',
        back: 'Zurück',
        propertyEditorAlert: {
            title: 'Eigenschaften-Editor',
            content: 'Möchten Sie den Eigenschafteneditor abbrechen?'
        }
    },
    dataSource: {
        newDatasource: 'NEUE DATASOURCE',
        sharedData: 'GEMEINSAME DATENQUELLE',
        ...
        datasourceConnection: {
            ...
            connect: 'Verbinden',
            cancel: 'Stornieren',
            disclaimerText: 'Durch das Verbinden stimmen Sie diesen zu',
            disclaimerLink: 'Begriffe',
            disclaimerTooltip: 'Der Kunde erkennt an und erklärt sich damit einverstanden, dass er durch die Aufforderung an {customBrandName}, im Namen des Kunden eine Verbindung zu dieser Datenquelle (bestehend aus Daten, Speichersystemen, Umgebung und anderen Bestandteilen) herzustellen, bestätigt, dass er über angemessene Rechte und Lizenzen der Eigentümer der Datenquelle verfügt, um dies zuzulassen Kunde und {customBrandName} im Auftrag des Kunden, um eine Verbindung zur Datenquelle herzustellen und diese zu verwenden. Der Kunde verpflichtet sich, {customBrandName} vollständig von allen Ansprüchen und Gebühren freizustellen. Wenn der Kunde nicht einverstanden ist, sollte der Kunde nicht verlangen, dass {customBrandName} eine Verbindung zur Datenquelle herstellt.'
        },
        advanceDatasource: {
        ...
        sqlDatasource: {
            ...
            advanceOption: {
                ...
                impersonate: 'Aktivieren Sie "Identitätswechsel"'
            },
            alertMessage: {
                connectionString: 'Geben Sie die Verbindungszeichenfolge an',
                promptText: 'Geben Sie den Eingabeaufforderungstext ein',
        ...
        elasticSearchDatasource: {
            ...
            none: 'Keiner',
            basicHttp: 'Einfache HTTP-Authentifizierung',
            userName: 'Nutzername',
            password: 'Passwort',
            port: 'Hafen',
            basicOption: {
        ...
        postgreSQLDatasource: {
            ...
            alertMessage: {
                aletServerName: 'Geben Sie den Servernamen an',
                aletPort: 'Geben Sie die Portnummer an',
                alertUserName: 'Geben Sie den Benutzernamen an',
                alertPassword: 'Geben Sie das Passwort an',
                alertDatabase: 'Geben Sie den Datenbanknamen an'
            }
        },
        sqlceDatasource: {
            connectionString: 'Verbindungsstring',
        ...
        oledbDatasource: {
            ...
            alertMessage: {
                connectionString: 'Geben Sie die Verbindungszeichenfolge an',
                prompt: 'Geben Sie den Eingabeaufforderungstext ein',
                userName: 'Geben Sie den Benutzernamen an',
                password: 'Geben Sie das Passwort an'
            }
        },
        webapiDatasource: {
            ...
            get: 'BEKOMMEN',
            post: 'POST',
            requestBody: 'Text anfordern',
            requestRaw: 'Roh',
            parameter: 'Parameter(s)',
            header: 'Kopfzeile (n)',
            dataFormat: 'Datei Format',
            json: 'JSON',
            csv: 'CSV',
            xml: 'XML',
            firstRow: 'Betrachten Sie die erste Zeile als Überschrift',
            authenticationType: 'Authentifizierungsart',
            userName: 'Nutzername',
            password: 'Passwort',
            separatorTypes: {
            ...
            alertMessage: {
                urlValidation: 'URL ist ungültig',
                userNameValidation: 'Geben Sie den Benutzernamen an',
                passwordValidation: 'Geben Sie das Passwort an',
                fieldsValidation: 'Geben Sie den Wert in Felder an',
                delimiterAlert: 'Geben Sie das Trennzeichen an'
            },
            none: 'Keiner',
            basicHttp: 'Grundlegende HTTP-Authentifizierung',
            addField: 'HINZUFÜGEN',
            ...
            closeToolTip: 'Schließen',
            pagination: {
                pagination: 'Paginierungstyp',
                offset: {
                    offset: 'Offset',
                    maxRow: 'Max Zeilen',
                    startFieldName: 'Feldname starten',
                    startValue: 'Startwert',
                    limitFieldName: 'Feldname begrenzen',
                    limitValue: 'Grenzwert',
                    passHeader: 'Über Kopf übergeben',
                    lookHeader: 'Schauen Sie in die Kopfzeile',
                    totalRecord: 'Pfad für Gesamtdatensätze',
                    dataIndicator: 'Datenanzeigepfad',
                    limitField: 'Grenze',
                ...
                nextpage: {
                    ...
                    maxIteration: 'Max Iterationen',
                    nextPageName: 'Feldname der nächsten Seite',
                    nextPageValue: 'Wert der nächsten Seite',
                    pageSizeFieldName: 'Feldname der Seitengröße',
                    pageSizeValue: 'Wert für die Seitengröße',
                    totalPagesPathName: 'Gesamtseitenpfad',
                    page: 'Seite',
                    pageSize: 'Seitengröße',
                    resultTotalPages: 'result.totalPages',
                },
                nexttoken: {
                    nexttoken: 'Nächstes Token',
                    nextTokenFieldName: 'Nächster Token-Feldname',
                    nextTokenPathName: 'Nächster Token-Pfad',
                    resultNextToken: 'result.nextPageToken',
                    nextTokenPath: 'nextToken',
                },
                nexturl: {
                    nexturl: 'Nächste URL',
                    nextURLPathName: 'Nächster URL-Pfad',
                    resultNextURL: 'result.metadata.nextUrl',
                },
                alertMessage: {
                    startFieldNameWarning: 'Der Name des Startfelds darf nicht leer sein',
                    limitFieldNameWarning: 'Der Name des Grenzfelds darf nicht leer sein',
                    dataFieldPathWarning: 'Es müssen entweder Gesamtdatensätze oder Datenindikatorpfad vorhanden sein',
                    nextPageFieldNameWarning: 'Der Feldname der nächsten Seite darf nicht leer sein',
                    nextPageSizeFieldNameWarning: 'Der Feldname der Seitengröße darf nicht leer sein',
                    nextTokenFieldNameWarning: 'Der Feldname des nächsten Tokens darf nicht leer sein',
                    nextTokenFieldValueWarning: 'Der Feldwert für das nächste Token darf nicht leer sein',
                    nextUrlPathWarning: 'Das nächste URL-Feld darf nicht leer sein',
                }
            }
        },
        jsonDatasource: {
            ...
            inLineText: 'In der Reihe',
            filePath: 'Dateipfad',
            urlLabel: 'Extern',
            maxFileSize: 'Maximale Dateigröße: 20 MB',
            uploadCompleted: 'Upload abgeschlossen',
            uploadFailed: 'Upload fehlgeschlagen',
            uploadInitiate: 'Upload einleiten ...',
            fileExceed: 'Die ausgewählte Datei überschreitet die Dateigrößenbeschränkung von ',
            uploadProgress: 'Hochladen ',
            alertMessage: {
                jsonAlert: 'Geben Sie JSON-Daten an',
                uploadAlert: 'Der Upload-Dateipfad ist leer',
                urlAlert: 'URL ist ungültig',
                xmlAlert: 'Geben Sie XML-Daten an',
                delimiterAlert: 'Geben Sie das Trennzeichen an'
            },
            waterMark: {
                xmlInline: 'Fügen Sie hier XML-Daten ein',
                jsonInline: 'Fügen Sie hier JSON-Daten ein'
            },
            separatorTypes: {
                comma: 'Komma',
                space: 'Raum',
            ...
            separator: 'Separator',
            delimiter: 'Trennzeichen',
            firstRowHeader: 'Betrachten Sie die erste Zeile als Überschrift',
            extractType: 'Typ extrahieren',
            extractTypes: {
        ...
        alertMessage: {
            headerLabel: 'Datenquelle',
            connectionFailed: 'Der Berichts-Designer konnte keine Verbindung zur Datenquelle herstellen',
            dataExtensionFailed: 'Der ausgewählte Datenanbieter ist nicht verfügbar. Bitte überprüfen Sie die Datenerweiterung.',
            dataSourceNotFound: 'Die Datenquelle ist für das ausgewählte Dataset nicht verfügbar.',
            ...
            emptyNameVaildation: 'Geben Sie den DataSource-Namen an',
        ...
        descriptionText: {
            ...
            elasticSearchInfo: 'Elasticsearch ist eine Suchmaschine, die auf der Lucene-Bibliothek basiert. Es bietet eine verteilte, mandantenfähige Volltextsuchmaschine mit HTTP-Webinterface und schemafreien JSON-Dokumenten. Elasticsearch kann verwendet werden, um alle Arten von Dokumenten zu durchsuchen. Es bietet außerdem eine skalierbare Suche, eine Suche nahezu in Echtzeit und unterstützt Mandantenfähigkeit. Der Elasticsearch-Konnektor ermöglicht Ihnen den Zugriff auf Daten von Elasticsearch-Clustern innerhalb der {customBrandName} Designer .',
            ...
            verticaInfo: 'Vertica ist das fortschrittlichste Unified Analytics Warehouse, das die Leistung eines hochleistungsfähigen, spaltenorientierten Speichers, fortschrittlicher Komprimierung, optimierter Projektionen und einer massiv parallel verarbeiteten SQL-Abfrage-Engine mit fortschrittlicher Analyse und maschinellem Lernen kombiniert, sodass Sie das wahre Potenzial von Ihre Daten ohne Grenzen und Kompromisse. Der Vertica-Konnektor ermöglicht Ihnen den Zugriff auf die Daten von Vertica-Datenbanken innerhalb der {customBrandName} Designer.',
            gcsqlInfo: 'Google Cloud SQL ist ein vollständig verwalteter Datenbankdienst, der auf MySQL und PostgreSQL basiert. Der Google Cloud SQL-Connector ermöglicht Ihnen den Zugriff auf Daten aus Google Cloud SQL-Datenbanken innerhalb der {customBrandName} Designer.',
            redshiftInfo: 'Amazon Redshift ist ein schnelles, skalierbares Data Warehouse, mit dem Sie alle Daten in Ihrem Data Warehouse und Data Lake einfach und kostengünstig analysieren können. Es basiert auf PostgreSQL. Der Amazon Redshift-Konnektor ermöglicht Ihnen den Zugriff auf Daten aus Amazon Redshift-Datenbanken innerhalb der {customBrandName} Designer.',
            rdsInfo: 'Amazon Relational Database Service (Amazon RDS) ist ein Webdienst, der das Einrichten, Betreiben und Skalieren einer relationalen Datenbank in der AWS Cloud vereinfacht. Es bietet kosteneffiziente Kapazität mit anpassbarer Größe, um die Automatisierung von Verwaltungsaufgaben zu reduzieren. Es bietet Datenbank-Engines wie Amazon Aurora, PostgreSQL, MySQL, MariaDB, Oracle Database und Microsoft SQL Server. Der Amazon RDS-Konnektor ermöglicht Ihnen den Zugriff auf Daten aus Amazon RDS-Datenbanken innerhalb der {customBrandName} Designer.'
        }
    },
    imageManager: {
    ...
    linkParameter: {
        title: 'Parameter',
        headerText: 'Verbindungsparameter',
    ...
    dataField: {
        ...
        dsNameValidation: {
            emptyName: 'Geben Sie den Datensatznamen an',
            duplicateName: 'Der angegebene Name ist bereits in der Datensatzliste vorhanden',
            specialCharacter: 'Der Datensatz Name darf keine Leerzeichen und Sonderzeichen enthalten'
        }
    },
    dataPanel: {
        itemTooltip: {
    ...
    reportViewer: {
        toolbar: {
            ...
            exportsetup: {
                ...
                contentText: 'Wählen Sie die Option "Setup exportieren", um die Bildqualität festzulegen,'
                    + 'den Worttyp zu speichern und das Dokument zu übertreffen.'
            },
            find: {
                headerText: 'Finden',
        ...
        pagesetupDialog: {
            ...
            paperTypes: [
                ...
                { text: 'Umschlag Nr. 10', value: 'Envelope #10' },
                { text: 'Umschlag Monarch', value: 'Envelope Monarch' },
                { text: 'Exekutive', value: 'Executive' },
                { text: 'Gesetzlich', value: 'Legal' },
                { text: 'Brief', value: 'Letter' },
                { text: 'Boulevardzeitung', value: 'Tabloid' },
        ...
        exportsetupDialog: {
            ...
            wordOptions: {
                ...
                layoutTypes: [
                    ...
                    { text: 'Höchststufe', value: 1 }
                ],
                protectionTypes: [
                    { text: 'Kein Schutz', value: -1 },
                    { text: 'Nur Überarbeitungen zulassen', value: 0 },
                    { text: 'Nur Kommentare zulassen', value: 1 },
                    { text: 'Nur Formularfelder zulassen', value: 2 },
                    { text: 'Nur lesen zulassen', value: 3 }
                ],
            },
            ...
            csvOptions: {
                ...
                qualifierList: [
                    { text: 'Anführungszeichen', value: '"' },
                    { text: 'Einzelzitate', value: '\'' },
                    { text: 'Keiner', value: '' },
                    { text: 'Brauch', value: 'Custom' }
                ],
                delimiterList: [
        ...
        findAlertMessage: {
            resultsEndReached: 'Sie haben das Ende der Suchergebnisse zurückgesetzt. IP Sie möchten fortfahren, '
                + 'Süden Schließen Sie die Dialogpose und suchen Sie erneut.',
            noResultsFound: 'Der angegebene Text stimmt mit keinem Inhalt des Berichts überein. '
                + 'Ändern Sie Ihr Suchwort und versuchen Sie es erneut.'
        },
        credential: {
            userName: 'Nutzername',
            password: 'Passwort'
    ...
    groupData: {
        grouping: 'Gruppierung',
        headerText: 'Gruppe',
        headerTextLabel: 'Gruppenbezeichnung',
        name: 'Name',
        label: 'Etikette',
    ...
    parameter: {
        ...
        configurationPanel: {
            ...
            uniqueValueLabel: 'Zeigen Sie eindeutige Werte an',
            sortValueLabel: 'Sortierung aktivieren',
            visibilityLable: 'Sichtweite',
            assignValueLable: 'Werte zuweisen >>',
            save: 'Sparen',
            cancel: 'Stornieren',
        ...
        alertMessage: {
            ...
            deleteConfirmation: 'Löschen Sie den Berichtsparameter'
        },
        assignData: {
            title: 'Parameter',
            ...
            errorMessage: {
                ...
                emptyDatasetField: 'Datensatzfeld ist erforderlich.',
                emptyDatasetValue: 'Wertfeld ist erforderlich.',
                labelFieldSyntax: 'Der eingegebene Wert im Beschriftungsfeld ist keine gültige Tokensyntax.',
                valueFieldSyntax: 'Der eingegebene Wert im Wertfeld ist keine gültige Tokensyntax.',
                emptyValue: 'Das Wertfeld ist leer. Der Parameter lässt keine leeren Werte zu.',
                nullValue: 'Im Wertfeld wurde ein Nullwert angegeben. Der Parameter lässt keine Nullwerte zu.'
            },
            closeToolTip: 'Schließen',
            deleteField: 'Feld löschen'
        }
    ...
    formatData: {
        ...
        typeFormat: {
            numberType: {
                ...
                decimalWatermark: 'Wert eingeben',
            ...
            percentage: {
                typeLabel: 'Prozentsatz',
                decimalPlaces: 'Nachkommastellen',
                includeSpace: 'Ein Leerzeichen einfügen'
            },
            scientific: {
                typeLabel: 'Wissenschaftlich',
                decimalPlaces: 'Nachkommastellen'
            },
            custom: {
                typeLabel: 'Brauch',
    ...
    expression: {
        ...
        description: {
            ...
            lookup: 'Verwenden Sie Lookup, um den Wert aus dem angegebenen Dataset für ein Name-Wert-Paar abzurufen, bei dem eine 1: 1-Beziehung besteht. Für ein ID-Feld in einer Tabelle können Sie beispielsweise Lookup verwenden, um das entsprechende Namensfeld aus einem Dataset abzurufen, das nicht an den Datenbereich gebunden ist.',
            lookupSet: 'Verwenden Sie LookupSet, um eine Reihe von Werten aus dem angegebenen Dataset für ein Name-Wert-Paar abzurufen, bei dem eine 1-zu-viele-Beziehung besteht. Für eine Kundenkennung in einer Tabelle können Sie beispielsweise mit LookupSet alle zugehörigen Telefonnummern für diesen Kunden aus einem Datensatz abrufen, der nicht an den Datenbereich gebunden ist.',
            ...
            renderInteractive: 'Ein Boolescher Wert, der angibt, ob die aktuelle Renderanforderung ein interaktives Format verwendet.',
            renderFormatName: 'Der Name des Renderers, wie er in der ReportServer-Konfigurationsdatei registriert ist.'
        },
        errorMessage: {
            emptyValue: 'Wert kann nicht leer sein',
            invalidValue: 'ist kein gültiger Wert'
        }
    },
    dataAssign: {
        measures: 'Maße',
    ...
    reportProperty: {
        ...
        interactiveSize: {
            categoryName: 'Interaktive Größe',
            enable: 'Aktivieren',
            width: 'Breite',
            height: 'Höhe',
        },
    ...
    textBoxProperty: {
        ...
        basicSettings: {
            ...
            format: 'Format',
            markupType: {
                categoryName: 'Markup-Typ',
                plaintext: 'Planen Sie Text',
                html: 'HTML'
            }
        },
        alignment: {
        ...
        interActiveSort: {
            ...
            userSort: {
                labelText: 'Ausdruck sortieren',
                scopePropertyLabel: 'Ausdrucksbereich sortieren',
                targetPropertyLabel: 'Ziel sortieren'
            }
        },
        localization: {
            categoryName: 'Lokalisierung',
            labelText: 'Sprache',
            direction: {
    ...
    designPanel: {
        ...
        bodyAreaLabel: 'Designbereich Körper',
        footerAreaLabel: 'Design Area Footer',
        rdlSwitcherAlert: {
            headerContent: 'Bericht',
            bodyContent: 'Der Bericht ist ein Downgrade auf die niedrigere Version von der aktuellen Version und einige Funktionen werden in dieser Version nicht unterstützt. Wollen Sie fortfahren ?'
        }
    },
    designContextMenu: {
        cutItem: 'Schnitt',
    ...
    tablixProperty: {
        ...
        headers: {
            ...
            fixedRow: 'Fester Row',
            fixedColumn: 'Feste Spalte',
            repeatRow: 'Wiederholen Row',
            repeatColumn: 'Spalte wiederholen'
        },
        font: {
            categoryName: 'Schriftart',
            defaultStyle: 'Standard',
    ...
    tablixTotalAlert: {
        headerLabel: 'Gesamtheader hinzufügen',
        staticLabel: 'Summe hinzufügen',
    ...
    queryDesigner: {
        ...
        schemaArea: {
            ...
            errorMessage: {
                ...
                confirmPermission: 'Beim Abrufen großer Datensätze wird das Rendern einige Zeit dauern. Möchten Sie trotzdem laden?'
            },
        ...
        joiner: {
            ...
            errorMessage: {
                ...
                saveJoinerAlert: 'Fehler beim Verknüpfen der ausgewählten Tabellen'
            }
        },
        credentialDialog: {
            title: 'Anmeldedialog',
            ...
            connect: 'Verbinden',
            close: 'Schließen',
            credentialLabel: 'Anmeldeinformationen für Datenquellen'
        },
        queryExpression: {
    ...
    codeDialog: {
        ...
        reference: {
            ...
            referenceSuffixToolTip: ' Informationen zu RDL-Assembly-Referenzen.'
        },
        classes: {
            title: 'Klassen',
            nameFieldWaterMark: 'Klassenname',
            instanceFieldWaterMark: 'Instanzname',
            emptyFieldValidation: 'Die Felder sind leer',
            emptyInstanceValueValidation: 'Das Feld ist leer',
            headerText: 'Liste der Klasseninstanzen',
            toolTip: 'Fügen Sie Klasseninstanzen hinzu, um auf Ihre Objektfunktionen im Bericht zuzugreifen.',
            toolTipSuffix: ' über RDL-Klassen.'
        },
        code: {
            title: 'Code',
            headerText: 'VB-Code-Funktion für den Bericht',
            tooltip: 'Die {customBrandName} Reporting Engine unterstützt VB - Code - Funktionen zur Integration mit Berichtselementen und Daten.',
            toolTipSuffix: ' über RDL-Code-Modul.'
        },
        customCode: 'Benutzerdefinierter Code-Editor',
        deleteReference: 'Referenzfeld löschen',
        deleteClass: 'Klassenfeld löschen',
        refer: ' Siehe die ',
        article: 'MSDN-Artikel'
    },
    ...
    parameterLayout: {
        title: 'Parameter Layout',
        ok: 'okay',
        cancel: 'Stornieren',
        closeToolTip: 'Schließen',
        deleteConfirmation: {
            title: 'Parameter',
            deleteCell: 'Berichtsparameter löschen',
            deleteCells: 'Berichtsparameter löschen'
        }
    },
    ...
    commonProperty: {
        ...
        fontSettings: {
            categoryName: 'Schriftarteneinstellungen',
            fontLabel: 'Schriftart',
    ...
    mapProperty: {
        ...
        commonProperties: {
            ...
            mapColorRule: {
                categoryName: 'Form Farbregel',
                colorRuleEnable: 'Farbregel aktivieren',
                dataValue: 'Datenwert',
                colorType: 'Art',
                colorRuleType: {
                    colorRange: 'Farbspektrum',
                    colorPalette: 'Farbpalette',
                    custom: 'Benutzerdefiniert'
                },
                ...
                distributionTypes: {
                    optimal: 'Optimal',
                    equalDistribution: 'Gleichmäßige Verteilung',
                    equalInterval: 'Gleiches Intervall',
                    custom: 'Benutzerdefiniert'
                },
                startValue: 'Startwert',
                endValue: 'Endwert',
                bucketCount: 'Eimerzahl',
                buckets: 'Eimer',
                palette: 'Palette',
                paletteTypes: {
                    random: 'Zufällig',
                ...
                customColors: 'Benutzerdefinierte Farben',
                startColor: 'Starten Sie Farbe',
                middleColor: 'Mittlere Farbe',
                endColor: 'Endfarbe',
                legendName: 'Legendenname',
                legendText: 'Legendentext',
                showInColorScale: 'In Farbskala anzeigen'
            },
            position: {
                topLeft: 'Oben links',
                topCenter: 'Oben in der Mitte',
        ...
        mapTitle: {
            ...
            position: 'Position',
            text: 'Text',
            enableTitle: 'Titel aktivieren'
        },
        basicSettings: {
            categoryName: 'Grundeinstellungen',
            polygonLayerName: 'Name des Polygon-Layers',
            shapeType: 'Formen',
            datasetName: 'Datensatz',
        ...
        legendSettings: {
            categoryLegend: 'Legende',
            showLegend: 'Legende aktivieren',
            ...
            legendFontStyle: 'Schriftschnitt',
            legendTitle: 'Titel',
            titleFont: 'Überschrift',
            titleFontStyle: 'Titel-Schriftschnitt',
        },
        pageBreak: {
            categoryName: 'Seitenumbruch',
            enablePageBreak: 'Seitenumbruch aktivieren',
        ...
        mapErrorMessage: {
            headerText: 'Karte',
            polygonErrorMessage: 'Fehler beim Konvertieren des Geojson mit aktualisierten Polygonen.',
            vectorDataToGeoJson: 'Fehler beim Abrufen des Geojson aus Vektordaten',
            shapeData: 'Kartenformdaten, die im Designer nicht konfiguriert wurden',
            shapeDateToGeoJson: 'Fehler beim Abrufen des Geojson aus Formdaten',
            multiLayer: 'Map unterstützt im Designer nicht mehrere Ebenen',
            polygonLayer: 'Map unterstützt im Designer nur Polygonebenen',
            fileTypes: 'Map unterstützt nur eingebettete und Shape-Dateitypen im Designer',
            unSupported: 'Map wird im Designer nicht unterstützt'
        },
        mapMarker: {
            colorRule: 'Marker-Farbregel',
            markerRule: 'Markierungsregel',
            enableMarkerRule: 'Markierungsregel aktivieren',
            enableSizeRule: 'Größenregel aktivieren',
            sizeRule: {
                categoryName: 'Regel für die Markergröße',
    ...
    mapBindingFields: {
        headerText: 'BindingField-Paare',
        addText: 'HINZUFÜGEN',
        updateText: 'Aktualisieren',
        fieldName: 'Feldname',
        bindingExpression: 'Bindungsausdruck',
        deletefield: 'Feld löschen',
        errorMessage: {
            bindingExpError: 'Wählen Sie einen Wert für den Bindungsausdruck',
            fieldNameError: 'Wählen Sie einen Wert für den Feldnamen',
            warningMessage: 'Die von Ihnen vorgenommenen Änderungen werden möglicherweise nicht aktualisiert.Möchten Sie trotzdem fortfahren?'
        }
    },
    mapBucket: {
    ...
    mapPolygons: {
        headerText: 'Polygone',
        addText: 'HINZUFÜGEN',
        polygonText: 'Kartenpolygon',
        updateText: 'Aktualisieren',
        editPolygon: 'Bearbeiten',
        deletePolygon: 'Polygon löschen',
        properties: 'Polygoneigenschaften',
        closeText: 'Schließen',
        saveText: 'Speichern',
        data: 'Daten',
        spatial: 'Räumlich',
        vectorData: 'Vektordaten',
        errorMessage: {
            warningMessage: 'Die von Ihnen vorgenommenen Änderungen werden möglicherweise nicht aktualisiert.Möchten Sie trotzdem fortfahren?'
        }
    },
    mapMarkerStyle: {
        headerText: 'Kartenmarkierung',
        updateText: 'Aktualisieren',
        add: 'HINZUFÜGEN',
        label: 'Markierungsstil',
        deletefield: 'Löschen',
        errorMessage: 'Die von Ihnen vorgenommenen Änderungen werden möglicherweise nicht aktualisiert.Möchten Sie trotzdem fortfahren?',
        styles: {
            circle: 'Kreis',
            none: 'Keiner',
            rectangle: 'Rechteck',
    ...
    mapFieldDefinition: {
        mapFieldTitle: 'Kartenfelddefinitionen',
        fieldName: 'Feldname',
        dataType: 'Datentyp',
        mapAlertMessage: 'Die von Ihnen vorgenommenen Änderungen werden möglicherweise nicht gespeichert. Möchten Sie trotzdem fortfahren?',
        addText: 'HINZUFÜGEN',
        errorMessage: {
            errorEmptyMessage: 'Geben Sie den Feldnamen an',
            sameCharacterMessage: 'Der Feldname ist bereits vorhanden'
        },
        updateText: 'AKTUALISIEREN'
    },
    mapCustomColors: {
        headerText: 'Benutzerdefinierte Farben',
        updateText: 'Aktualisieren',
        add: 'HINZUFÜGEN',
        label: 'Farbe',
        deletefield: 'Löschen',
    ...
    reportVariable: {
        ...
        value: 'Wert',
        deletefield: 'Feld löschen',
        checkBoxTooltip: 'Schreibgeschützt',
        errorMessage: {
            warningMessage: 'Die von Ihnen vorgenommenen Änderungen werden möglicherweise nicht aktualisiert.Möchten Sie trotzdem fortfahren?',
            emptyAlert: 'Name darf nicht leer sein',
            duplicateName: 'Name existiert bereits',
            specialCharacter: 'Name sollte keine Leerzeichen und Sonderzeichen enthalten'
        }
    },
    indicatorStates: {
        headerText: 'Indikatorstaaten',
        addText: 'HINZUFÜGEN',
        updateText: 'Aktualisieren',
        deletefield: 'Feld löschen',
        ...
        indicatorStateValue: 'Indikatorstatuswert',
        errorMessage: {
            warningMessage: 'Die von Ihnen vorgenommenen Änderungen werden möglicherweise nicht aktualisiert. Möchten Sie trotzdem fortfahren?'
        }
    },
    webDataExpression: {
        ...
        password: 'Passwort',
        valueWaterMark: 'Wert',
        emptyValue: 'Geben Sie den Ausdruckswert an'
    }
};
