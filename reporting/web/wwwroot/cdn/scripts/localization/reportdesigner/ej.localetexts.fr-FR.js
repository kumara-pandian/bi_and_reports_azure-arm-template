ej.ReportDesigner.Locale['fr-FR'] = {
    itemPanel: {
        ...
        labelText: 'Conteneur de panneaux',
        expandText: 'Développer',
        collapseText: 'Effondrer',
        customTooltip: {
            tooltip: {
        ...
        groupItems: {
            ...
            comparison: {
                ...
                Items: {
                    ...
                    'rangeColumn': {
                        displayText: 'Colonne de plage',
                        tooltip: {
                            requirements: '1 ou plusieurs valeurs et 1 ou plusieurs colonnes.',
                            description: 'Affiche une plage de données en traçant deux valeurs Y par point de données',
                            title: 'Colonne de plage'
                        }
                    },
                    'rangeBar': {
                        displayText: 'Barre de portée',
                        tooltip: {
                            requirements: '1 ou plusieurs valeurs et 1 ou plusieurs colonnes.',
                            description: 'Affiche une plage de données en traçant horizontalement deux valeurs Y par point de données',
                            title: 'Barre de portée'
                        }
                    },
            ...
            kpi: {
                ...
                Items: {
                    ...
                    'indicator': {
                        ...
                        tooltip: {
                            requirements: '1 valeur.',
                            description: 'Représentation minimale des jauges qui visualisent l\'état d\'une donnée unique.',
                            title: 'Indicateur'
                        }
                    }
                }
            ...
            gauge: {
                ...
                Items: {
                    'radialgauge': {
                        displayText: 'Jauge radiale',
                        tooltip: {
                            requirements: '1 valeur et 0 ou 1 valeur de début / fin.',
                            description: 'Visualisez les tendances grâce à des indicateurs de performance clés comme les valeurs et les objectifs.',
                            title: 'Jauge radiale'
                        }
                    },
                    'lineargauge': {
                        displayText: 'Jauge linéaire',
                        tooltip: {
                            requirements: '1 valeur et 0 ou 1 valeur de début / fin.',
                            description: 'Visualisez les tendances grâce à des indicateurs de performance clés comme les valeurs et les objectifs. Souvent utilisé dans les tableaux et les matrices.',
                            title: 'Jauge linéaire'
                        }
                    }
                }
            },
            ...
            distribution: {
                ...
                Items: {
                    ...
                    'rangeArea': {
                        displayText: 'Zone de portée',
                        tooltip: {
                            requirements: '1 ou plusieurs valeurs et 1 ou plusieurs colonnes.',
                            description: 'Un type de graphique en aires où plutôt que de commencer sur l\'axe, l\'aire est représentée par l\'espace entre deux valeurs.',
                            title: 'Zone de portée'
                        }
                    },
                    'smoothRangeArea': {
                        displayText: 'Zone de plage lisse',
                        tooltip: {
                            requirements: '1 ou plusieurs valeurs et 1 ou plusieurs colonnes.',
                            description: 'Lignes courbes pour connecter des points de données plutôt que des lignes droites.',
                            title: 'Zone de plage lisse'
                        }
                    }
                }
            },
            dataRegions: {
                ...
                Items: {
                    ...
                    'matrix': {
                        displayText: 'Matrice',
                        tooltip: {
                            requirements: '1 ou plusieurs valeurs et 1 ou plusieurs lignes / colonnes.',
                            description: 'Afficher les données résumées sous forme de tableau croisé.',
                            title: 'Matrice'
                        }
                    }
                }
            ...
            maps: {
                ...
                Items: {
                    'map': {
                        displayText: 'Carte',
                        tooltip: {
                            requirements: 'Affichez une carte du rapport.',
                            description: 'Affiche les données analytiques sur un arrière-plan géographique.',
                            title: 'Carte'
                        }
                    }
                }
    ...
    linkReport: {
        ...
        labelText: 'Lier un sous-rapport à l\'élément de rapport',
        reportDialog: 'Ouvrir le dialogue de rapport',
        setParameter: 'Définir les paramètres',
        dialogHeader: 'Concepteur de rapports',
        alertContent: 'Impossible d\'accéder aux rapports du serveur.'
    },
    imageProperty: {
        basicSettings: {
        ...
        appearance: {
            ...
            borderProperties: {
                defaultColor: 'Couleur de la bordure',
                defaultSize: 'Taille de la frontière',
                defaultStyle: 'Style de bordure',
                leftColor: 'Couleur de bordure gauche',
                leftSize: 'Bordure gauche taille',
                leftStyle: 'Style de bordure gauche',
                topColor: 'Couleur de la bordure',
                topSize: 'Taille supérieure de la frontière',
                topStyle: 'Style de bordure',
                rightColor: 'Couleur droite de la bordure',
                rightSize: 'Taille droite',
                rightStyle: 'Style de bordure droite',
                bottomColor: 'Couleur de fond de bordure',
                bottomSize: 'Taille inférieure de la frontière',
                bottomStyle: 'Style de fond de bordure'
            }
        },
        size: {
            categoryName: 'Taille',
    ...
    chartProperty: {
        ...
        basicSettings: {
            categoryName: 'Paramètres de base',
            chartType: {
                categoryName: 'Type de graphique',
                column: 'Colonne',
                ...
                stackedAreaPercent: 'Surface empilée100%',
                line: 'Ligne',
                smoothLine: 'Ligne lisse',
                steppedLine: 'Ligne à marches',
                lineWithMarkers: 'Ligne avec des marqueurs',
                smoothLineWithMarkers: 'Ligne lisse avec des marqueurs',
                scatter: 'Dispersion',
                bubble: 'Bulle',
                polar: 'Polaire',
                radar: 'Radar',
                rangeArea: 'Zone de portée',
                rangeColumn: 'Colonne de plage',
                rangeBar: 'Barre de portée',
                smoothRangeArea: 'Zone de plage lisse',
                alertSwitchChartType: 'Tous les types de séries seront modifiés. Voulez-vous continuer?'
            },
            legendProperties: {
                booleanPropertyLabel: 'Afficher la légende',
                title: 'Titre',
                titleFont: 'Police de titre',
                titleFontStyle: 'Style de police du titre',
                titleAlignment: 'Alignement du titre',
                position: 'Position de légende',
        ...
        forecast: {
            categoryName: 'Paramètres de prévision',
            enableSettings: 'Permettre',
            forecastlength: 'Longueur (points)',
            confidenceInterval: 'Intervalle de confiance',
            seasonality: 'Saisonnalité (points)',
            enableSeries: 'Prévoir',
            forecastColor: 'Couleur des prévisions',
            confidenceEnable: 'Confiance',
            confidenceColor: 'Couleur de confiance',
            bandStyle: 'Style de bande de confiance',
            confidenceBandTypes: {
                fill: 'Remplir',
                linetype: 'Ligne',
                dot: 'Point'
        ...
        title: {
            categoryName: 'Titre',
            booleanPropertyLabel: 'Afficher le titre du graphique',
        ...
        axis: {
            ...
            labelFont: 'Police de l\'étiquette',
            ...
            tickProperties: {
                sizeLabel: 'Taille de tique',
                colorLabel: 'Tick Couleur',
                width: 'Largeur',
                length: 'Longueur'
            },
            ...
            lineProperties: {
                ...
                size: 'La taille de la ligne',
                style: 'Style de trait'
            },
            gridLineProperties: {
                color: 'Couleur de la grille',
                size: 'Taille de la grille',
                style: 'Style de ligne de grille'
            },
            chartTicks: {
        ...
        gridLine: {
            ...
            style: {
                booleanPropertyLabel: 'Afficher le quadrillage mineur',
                major: 'Style de grille principal',
                minor: 'Style de grille secondaire'
            }
        },
        pageBreak: {
            categoryName: 'Saut de page',
            booleanPropertyLabel: 'Activer le saut de page',
        ...
        seriesSettings: {
            ...
            basicSettings: {
                ...
                smartLabelProperties: {
                    booleanPropertyLabel: 'activer l\'étiquette intelligente',
            ...
            link: 'Lien',
            markerProperties: {
                categoryName: 'Paramètres du marqueur',
                booleanPropertyLabel: 'Afficher le marqueur',
                color: 'Couleur',
                typePropertyLabel: 'Type de marqueur',
                types: {
                    square: 'Carré',
                    circle: 'Cercle',
                    diamond: 'diamant',
            ...
            dataLabelProperties: {
                categoryName: 'Paramètres d\'étiquette de données',
                booleanPropertyLabel: 'Afficher l\'étiquette de données',
                formatPropertyLabel: 'Format',
                labelPropertyText: 'Étiquette',
                valueAsText: 'utiliser la valeur comme étiquette',
                types: {
                    valueX: '#VALX',
                    valueY: '#VALY',
                    valueY2: '#VALY2',
        ...
        borderColor: 'Couleur de la bordure',
        borderSize: 'Taille de la frontière',
        fontStyle: 'Le style de police',
    ...
    gaugeProperty: {
        ...
        labelCategory: {
            ...
            alignmentTypes: {
                ...
                rightAlignment: 'Droit',
                topAlignment: 'Haut',
                middleAlignment: 'Milieu',
                bottomAlignment: 'Bas'
            },
    ...
    indicatorProperty: {
        typesCategory: {
            categoryName: 'Types d\'indicateurs',
            types: {
                threeColoredArrows: 'Trois flèches de couleur',
                threeGrayArrows: 'Trois flèches grises',
                threeUpDownTriangles: 'Trois triangles vers le haut',
                fourGrayArrows: 'Quatre flèches grises',
                fourColoredArrows: 'Quatre flèches de couleur',
                fiveGrayArrows: 'Cinq flèches grises',
                fiveColoredArrows: 'Cinq flèches de couleur',
                threeCircledSymbols: 'Trois symboles entourés',
                threeUncircledSymbols: 'Trois symboles non cernés',
                threeFlags: 'Trois drapeaux',
                threeUnrimmedTrafficLights: 'Trois feux de signalisation non coupés',
                threeRimmedTrafficLights: 'Trois feux tricolores',
                threeSigns: 'Trois signes',
                fourTrafficLights: 'Quatre feux de circulation',
                redToBlack: 'Rouge au noir',
                threeStars: 'Trois étoiles',
                fiveStars: 'Cinq étoiles',
                fourRatings: 'Quatre évaluations',
                fiveRatings: 'Cinq évaluations',
                fiveQuarters: 'Cinq trimestres',
                fiveBlocks: 'Cinq blocs',
                custom: 'Douane'
            }
        },
        valueCategory: {
            categoryName: 'Valeur de l\'indicateur',
            value: 'Valeur',
        ...
        states: {
            categoryName: 'États indicateurs',
            icons: {
                circle: 'Cercle',
                flag: 'Drapeau',
                arrowDown: 'Flèche vers le bas',
                arrowDownIncline: 'Flèche vers le bas inclinaison',
                arrowSide: 'Côté flèche',
                arrowUp: 'Flèche vers le haut',
                arrowUpIncline: 'Flèche vers le haut',
                boxesNoneFilled: 'Boîtes non remplies',
                boxesOneFilled: 'Des boîtes remplies',
                boxesTwoFilled: 'Boites Deux Remplies',
                boxesThreeFilled: 'Boites Trois Remplies',
                boxesAllFilled: 'Boîtes toutes remplies',
                quartersNoneFilled: 'Quarters non remplis',
                quartersOneFilled: 'Un quartier rempli',
                quartersTwoFilled: 'Trois quarts remplis',
                quartersThreeFilled: 'Trois quarts remplis',
                quartersAllFilled: 'Quarters tous remplis',
                signalMeterNoneFilled: 'Signal Meter Aucun Rempli',
                signalMeterOneFilled: 'Signal Meter one rempli',
                signalMeterTwoFilled: 'Signal Meter Two rempli',
                signalMeterThreeFilled: 'Signal Meter Three rempli',
                signalMeterFourFilled: 'Signal Meter Four rempli',
                starQuartersNoneFilled: 'Quartiers étoiles non remplis',
                starQuartersOneFilled: 'Star Quarters One rempli',
                starQuartersTwoFilled: 'Deux quartiers remplis',
                starQuartersThreeFilled: 'Star Quarters Trois Rempli',
                starQuartersAllFilled: 'Quartiers d\'étoiles remplis',
                threeSignsCircle: 'Cercle des trois signes',
                threeSignsDiamond: 'Trois signes diamant',
                threeSignsTriangle: 'Triangle des Trois Signes',
                threeSymbolCheck: 'Vérification de trois symboles',
                threeSymbolCross: 'Croix à trois symboles',
                threeSymbolExclamation: 'Trois exclamations de symboles',
                threeSymbolUnCircledCheck: 'Chèque non symbolisé à trois symboles',
                threeSymbolUnCircledCross: 'Croix à trois symboles non courbée',
                threeSymbolUnCircledExclamation: 'Trois exclamations non courbées',
                trafficLight: 'Feu de circulation',
                trafficLightUnrimmed: 'Feux de circulation non coupés',
                triangleDash: 'Triangle Dash',
                triangleDown: 'Triangle vers le bas',
                triangleUp: 'Triangle vers le bas',
                lightArrowDown: 'Légère flèche vers le bas',
                lightArrowDownIncline: 'Légère flèche inclinée',
                lightArrowSide: 'Flèche claire',
                lightArrowUp: 'Légère flèche vers le haut',
                lightArrowUpIncline: 'Légère flèche vers le haut',
                buttonStop: 'Bouton d\'arrêt',
                buttonPlay: 'Bouton jouer',
                buttonPause: 'Bouton Pause',
                faceSmile: 'Visage sourire',
                faceNeutral: 'Visage Neutre',
                faceFrown: 'Visage froncé les sourcils',
                none: 'Aucune'
            }
        },
        miscellaneous: {
    ...
    linearGaugeProperty: {
        scaleCategory: {
            ...
            scaleBarWidth: 'Largeur',
            scaleBarColor: 'Couleur',
            linearTypecategory: {
                linearType: 'Type',
            ...
            scaleLabelsCategory: {
                showScaleLabels: 'Étiquettes',
                showScaleLabelsAtEnd: 'Afficher les étiquettes à la fin'
            },
            ticksCategory: {
                tickMark: 'Coche',
                majorTick: 'Tique majeure',
                minorTick: 'Tique mineure',
                majorTickPlacement: 'Placement majeur des tiques',
                minorTickPlacement: 'Placement des tiques mineures',
                tickInterval: 'Intervalle',
                tickLength: 'Longueur',
                tickWidth: 'Largeur',
                tickColor: 'Couleur'
            },
            pointerCategory: {
                pointer: 'Aiguille',
                enablePointer: 'Activer le pointeur',
                pointerValue: 'Valeur',
                pointerType: 'Type',
                pointerTypes: {
                    marker: 'Marqueur',
                ...
                pointerWidth: 'Largeur',
                pointerColor: 'Couleur',
                markerLength: 'Longueur du marqueur',
    ...
    radialGaugeProperty: {
        scaleCategory: {
            ...
            radialTypecategory: {
                radialType: 'Type',
                radial: 'Radiale',
                halfCircle: 'Demi cercle',
                auto: 'Auto'
            },
            scaleLabelsCategory: {
                showScaleLabels: 'Étiquettes',
                showScaleLabelsAtEnd: 'Afficher les étiquettes à la fin',
                rotateScaleLabels: 'Faire pivoter les étiquettes'
            },
            ticksCategory: {
                tickMark: 'Coche',
                majorTick: 'Tique majeure',
    ...
    subReportProperty: {
        ...
        noRows: {
            ...
            textAlign: {
                categoryName: 'Alignement de texte',
                default: 'Défaut',
                left: 'La gauche',
                right: 'Droite',
                center: 'Centre'
            ...
            writingMode: {
                categoryName: 'Mode d\'écriture',
                default: 'Défaut',
                horizontal: 'Horizontal',
                vertical: 'Verticale',
                rotateProperty: 'Rotation270'
            }
        },
        visibility: {
            categoryName: 'Visibilité',
    ...
    rectangleProperty: {
        ...
        pageBreak: {
            categoryName: 'Saut de page',
            enableProperty: {
                labelText: 'Activer le saut de page',
                breakLocation: {
                    labelText: 'Break Lieu',
                    none: 'Aucun',
                    start: 'Début',
                    end: 'Fin',
        ...
        dataElement: {
            ...
            elementOutput: {
                ...
                categoryName: 'Production',
                output: 'Production',
                contentsOnly: 'Table des matières'
            }
        }
    },
    browseFile: {
        ...
        reloadAriaLabelText: 'Parcourir Recharger',
        containerAriaLabelText: 'Parcourir le conteneur de fichiers'
    },
    publishReport: {
        title: 'Publier en tant que rapport',
        publish: 'Publier',
        category: 'Catégorie',
        selectCategory: 'Veuillez créer une catégorie',
        ...
        addCategory: {
            ...
            name: 'prénom',
            description: 'La description',
            emptyValidation: 'Veuillez saisir le nom de la catégorie',
            duplicateNameValidation: 'Le nom de l\'article existe déjà',
            createActionFailure: 'Échec de la création de la catégorie sur le serveur',
            saveLabel: 'sauver'
        },
        warningMessage: {
            sameNameError: 'Un rapport du même nom existe déjà dans la catégorie',
            replaceMessage: '. Voulez-vous le remplacer?',
            publishAsReport: 'Publier en tant que rapport'
        },
    },
    expressionMenu: {
        reset: 'Réinitialiser',
    ...
    propertyPanel: {
        ...
        alertMessage: {
            emptyNameValidation: 'Le nom ne peut pas être vide',
            duplicateNameValidation: 'Le nom existe déjà',
            invalidCharacterValidation: 'Le nom ne doit pas contenir d\'espaces et de caractères spéciaux',
            alertDialogHeader: 'Propriétés',
            specialCharacterValidation: 'La valeur de la propriété ne doit pas contenir d\'espaces ni de caractères spéciaux.'
        },
        unitType: {
            inchText: 'dans',
            centimeterText: 'cm',
        ...
        None: 'Aucun',
        propertyEdit: 'Éditer',
        itemCountWaterMark: 'articles',
        back: 'Retour',
        propertyEditorAlert: {
            title: 'Éditeur de propriétés',
            content: 'Voulez-vous annuler l\'éditeur de propriétés?'
        }
    },
    dataSource: {
        newDatasource: 'NOUVELLE DATASOURCE',
        sharedData: 'SOURCE DE DONNÉES PARTAGÉE',
        ...
        datasourceList: {
            ...
            contextMenu: {
                edit: 'modifier',
                deleteItem: 'Effacer',
                create: 'Créer un Ensemble de données',
                clone: 'Cloner'
            }
        },
        datasourceType: {
        ...
        sqlDatasource: {
            ...
            advanceOption: {
                ...
                impersonate: 'Activer l\'usurpation d\'identité'
            },
            alertMessage: {
                connectionString: 'Spécifiez la chaîne de connexion',
                promptText: 'Spécifiez le texte d\'invite',
        ...
        elasticSearchDatasource: {
            ...
            none: 'Aucun',
            basicHttp: 'Authentification HTTP de base',
            userName: 'Nom d\'utilisateur',
            password: 'Mot de passe',
            port: 'Port',
            basicOption: {
        ...
        postgreSQLDatasource: {
            ...
            alertMessage: {
                aletServerName: 'Indiquez le nom du serveur',
                aletPort: 'Spécifiez le numéro de port',
                alertUserName: 'Précisez le nom d\'utilisateur',
                alertPassword: 'Spécifiez le mot de passe',
                alertDatabase: 'Indiquez le nom de la base de données'
            }
        },
        sqlceDatasource: {
            connectionString: 'Chaîne de connexion',
        ...
        oledbDatasource: {
            ...
            alertMessage: {
                connectionString: 'Spécifiez la chaîne de connexion',
                prompt: 'Spécifiez le texte d\'invite',
                userName: 'Précisez le nom d\'utilisateur',
                password: 'Spécifiez le mot de passe',
            }
        },
        webapiDatasource: {
            ...
            get: 'AVOIR',
            post: 'PUBLIER',
            requestBody: 'Organe de demande',
            requestRaw: 'Brute',
            parameter: 'Paramètre(s)',
            header: 'En-tête(s)',
            dataFormat: 'Format des données',
            json: 'JSON',
            csv: 'CSV',
            xml: 'XML',
            firstRow: 'Considérez la première ligne comme en-tête',
            authenticationType: 'type d\'identification',
            userName: 'Nom d\'utilisateur',
            password: 'Mot de passe',
            separatorTypes: {
            ...
            alertMessage: {
                urlValidation: 'L\'URL n\'est pas valide',
                userNameValidation: 'Spécifiez le nom d\'utilisateur',
                passwordValidation: 'Spécifiez le mot de passe',
                fieldsValidation: 'Spécifiez la valeur dans les champs',
                delimiterAlert: 'Spécifiez le délimiteur'
            },
            none: 'Aucun',
            basicHttp: 'Authentification HTTP de base',
            addField: 'Ajouter',
            ...
            closeToolTip: 'proche',
            pagination: {
                pagination: 'Type de pagination',
                offset: {
                    offset: 'Décalage',
                    maxRow: 'Lignes max',
                    startFieldName: 'Nom du champ de départ',
                    startValue: 'Valeur de départ',
                    limitFieldName: 'Nom du champ limite',
                    limitValue: 'Valeur limite',
                    passHeader: 'Passer via l\'en-tête',
                    lookHeader: 'Regardez dans l\'en-tête',
                    totalRecord: 'Chemin total des enregistrements',
                    dataIndicator: 'Chemin de l\'indicateur de données',
                    limitField: 'limite',
                    resultTotalRecord: 'résultat.total',
                    resultDataIndicator: 'résultat.Les données.valeur',
                },
                nextpage: {
                    nextpage: 'Page suivante',
                    maxIteration: 'Itérations max',
                    nextPageName: 'Nom du champ Page suivante',
                    nextPageValue: 'Valeur de la page suivante',
                    pageSizeFieldName: 'Nom du champ Taille de la page',
                    pageSizeValue: 'Valeur de taille de page',
                    totalPagesPathName: 'Chemin total des pages',
                    page: 'page',
                    pageSize: 'taille de la page',
                    resultTotalPages: 'résultat.pages totales',
                },
                nexttoken: {
                    nexttoken: 'Jeton suivant',
                    nextTokenFieldName: 'Nom du champ Token suivant',
                    nextTokenPathName: 'Chemin du jeton suivant',
                    resultNextToken: 'résultat.jeton de page suivante',
                    nextTokenPath: 'suivantJeton',
                },
                nexturl: {
                    nexturl: 'URL suivante',
                    nextURLPathName: 'Chemin d\'URL suivant',
                    resultNextURL: 'résultat.métadonnées.URL suivante',
                },
                alertMessage: {
                    startFieldNameWarning: 'Le nom du champ de début ne peut pas être vide',
                    limitFieldNameWarning: 'Le nom du champ limite ne peut pas être vide',
                    dataFieldPathWarning: 'Le nombre total d\'enregistrements ou le chemin de l\'indicateur de données doivent être présents',
                    ...
                    nextTokenFieldValueWarning: 'La valeur du champ de jeton suivant ne peut pas être vide',
                    nextUrlPathWarning: 'Le champ d\'URL suivant ne peut pas être vide',
                }
            }
        },
        jsonDatasource: {
            ...
            uploadInitiate: 'Lancement du téléchargement...',
            fileExceed: 'Le fichier sélectionné dépasse la taille limite de fichier de ',
            uploadProgress: 'Téléchargement ',
            alertMessage: {
                jsonAlert: 'Spécifier les données JSON',
                uploadAlert: 'Veuillez sélectionner un fichier',
                urlAlert: 'L\'URL n\'est pas valide',
                xmlAlert: 'Spécifiez les données XML',
                delimiterAlert: 'Spécifiez le délimiteur'
            },
            waterMark: {
                xmlInline: 'Collez les données XML ici',
                jsonInline: 'Collez les données JSON ici'
            },
            separatorTypes: {
                comma: 'Virgule',
                space: 'Espace',
            ...
            separator: 'Séparateur',
            delimiter: 'Délimiteur',
            firstRowHeader: 'Considérez la première ligne comme en-tête',
            extractType: 'Type d\'extrait',
            extractTypes: {
        ...
        alertMessage: {
            headerLabel: 'La source de données',
            deleteValue: 'Supprimer la source de données \'',
            connectionFailed: 'Le concepteur de rapports n\'a pas réussi à connecter la source de données',
            dataExtensionFailed: 'Le fournisseur de données sélectionné n\'est pas disponible. Veuillez vérifier l\'extension de données.',
            dataSourceNotFound: 'La source de données n\'est pas disponible pour l\'ensemble de données sélectionné.',
            ...
            emptyNameVaildation: 'Spécifiez le nom DataSource',
        ...
        descriptionText: {
            ...
            elasticSearchInfo: 'Elasticsearch est un moteur de recherche basé sur la bibliothèque Lucene. Il fournit un moteur de recherche en texte intégral distribué et mutualisé avec une interface Web HTTP et des documents JSON sans schéma. Elasticsearch peut être utilisé pour rechercher tous types de documents. Il fournit également une recherche évolutive, une recherche en temps quasi réel et prend en charge la multilocation. Le connecteur Elasticsearch vous permet d\'accéder aux données des clusters Elasticsearch au sein du {customBrandName} Designer.',
            ...
            verticaInfo: 'Vertica est l\'entrepôt d\'analyse unifié le plus avancé, qui combine la puissance d\'un stockage en colonnes hautes performances, d\'une compression avancée, de projections optimisées et d\'un moteur de requête SQL à traitement massivement parallèle avec des analyses avancées et l\'apprentissage automatique, afin que vous puissiez libérer le véritable potentiel de vos données sans limites ni compromis. Le connecteur Vertica vous permet d\'accéder aux données des bases de données Vertica au sein du {customBrandName} Designer.',
            gcsqlInfo: 'Google Cloud SQL est un service de base de données entièrement géré basé sur MySQL et PostgreSQL. Le connecteur Google Cloud SQL vous permet d\'accéder aux données des bases de données Google Cloud SQL dans le {customBrandName} Designer.',
            redshiftInfo: 'Amazon Redshift est un entrepôt de données rapide et évolutif qui permet d\'analyser simplement et à moindre coût toutes les données de votre entrepôt de données et de votre lac de données.Il est construit sur PostgreSQL.Le connecteur Amazon Redshift vous permet d\'accéder aux données des bases de données Amazon Redshift dans le {customBrandName} Designer.',
            rdsInfo: 'Amazon Relational Database Service (Amazon RDS) est un service Web qui facilite la configuration, l\'exploitation et la mise à l\'échelle d\'une base de données relationnelle dans le cloud AWS.Il offre une capacité redimensionnable et économique pour réduire l\'automatisation des tâches administratives. Il fournit des moteurs de base de données tels qu\'Amazon Aurora, PostgreSQL, MySQL, MariaDB, Oracle Database et Microsoft SQL Server.Le connecteur Amazon RDS vous permet d\'accéder aux données des bases de données Amazon RDS dans le {customBrandName} Designer.'
        }
    },
    imageManager: {
    ...
    reportViewer: {
        toolbar: {
            ...
            exportsetup: {
                ...
                contentText: 'Choisissez l’option d’installation d’exportation pour définir la qualité de l’image,'
                    + 'enregistrer le type de mot et excel document.'
            },
            find: {
                headerText: 'Trouve',
        ...
        pagesetupDialog: {
            ...
            paperTypes: [
                ...
                { text: 'Enveloppe #10', value: 'Envelope #10' },
                { text: 'Enveloppe monarque', value: 'Envelope Monarch' },
                { text: 'Exécutif', value: 'Executive' },
                { text: 'Légal', value: 'Legal' },
                { text: 'Lettre', value: 'Letter' },
                { text: 'Tabloïde', value: 'Tabloid' },
        ...
        exportsetupDialog: {
            ...
            wordOptions: {
                ...
                layoutTypes: [
                    { text: 'Défaut', value: 0 },
                    { text: 'Haut niveau', value: 1 }
                ],
                protectionTypes: [
                    { text: 'Pas de protection', value: -1 },
                    { text: 'Autoriser les révisions uniquement', value: 0 },
                    { text: 'Autoriser les commentaires uniquement', value: 1 },
                    { text: 'Autoriser uniquement les champs de formulaire', value: 2 },
                    { text: 'Autoriser la lecture seule', value: 3 }
                ],
            },
            ...
            csvOptions: {
                ...
                qualifierList: [
                    { text: 'Double citation', value: '"' },
                    { text: 'Guillemets simples', value: '\'' },
                    { text: 'Rien', value: '' },
                    { text: 'Personnalisé', value: 'Custom' }
                ],
                delimiterList: [
        ...
        findAlertMessage: {
            resultsEndReached: 'Vous avez atteint la fin des résultats de recherche. Si vous souhaitez continuer, '
                + 'fermez la boîte de dialogue et relancez la recherche.',
            noResultsFound: 'Le texte spécifié ne correspond à aucun des contenus du rapport. '
                + 'Modifiez votre mot-clé de recherche et réessayez.'
        },
        credential: {
            userName: 'Nom d\'utilisateur',
            password: 'mot de passe'
        ...
        alertMessage: {
            ...
            RVERR0001: 'ReportViewer n\'a pas pu charger le rapport',
            RVERR0002: 'ReportViewer n\'a pas pu traiter le rapport',
            RVERR0003: 'Une erreur s\'est produite dans le retour des données ajax',
            RVERR0004: 'Sélectionnez une valeur pour le paramètre',
            RVERR0005: 'Il manque une valeur au paramètre {parameter name}',
            RVERR0006: 'Veuillez saisir l\'entrée du type de données flottant',
            RVERR0007: 'Entrez l\'entrée du type de données entier',
            RVERR0008: 'ReportViewer n\'a pas pu valider les informations d\'identification de la source de données',
    ...
    groupData: {
        grouping: 'Regroupement',
        headerText: 'Groupe',
        headerTextLabel: 'Label de groupe',
        name: 'prénom',
        label: 'Étiquette',
    ...
    parameter: {
        ...
        configurationPanel: {
            ...
            uniqueValueLabel: 'Afficher des valeurs uniques',
            sortValueLabel: 'Activer le tri',
            visibilityLable: 'Visibilité',
            assignValueLable: 'Attribuer des valeurs >>',
            save: 'sauvegarder',
            cancel: 'Annuler',
        ...
        alertMessage: {
            ...
            deleteConfirmation: 'Supprimer le paramètre de rapport'
        },
        assignData: {
            title: 'Paramètre',
            ...
            errorMessage: {
                ...
                emptyDatasetField: 'Le champ Ensemble de données est requis. ',
                emptyDatasetValue: 'Le champ de valeur est requis. ',
                labelFieldSyntax: 'La valeur entrée dans le champ label n\'est pas une syntaxe de jeton valide. ',
                valueFieldSyntax: 'La valeur entrée dans le champ de valeur n\'est pas une syntaxe de jeton valide. ',
                emptyValue: 'Le champ de valeur est vide. Le paramètre n\'autorise pas les valeurs vides. ',
                nullValue: 'Dans le champ de valeur, une valeur nulle a été spécifiée. Le paramètre n\'autorise pas les valeurs nulles. '
            },
            closeToolTip: 'Fermer',
            deleteField: 'Supprimer le champ'
        }
    ...
    formatData: {
        ...
        typeFormat: {
            numberType: {
                ...
                decimalWatermark: 'Entrez la valeur',
            ...
            date: {
                typeLabel: 'Rendez-vous amoureux',
                valueTypeLabel: 'Rendez-vous amoureux'
            },
            time: {
                typeLabel: 'Temps',
                valueTypeLabel: 'Temps'
            },
            percentage: {
    ...
    expression: {
        ...
        description: {
            ...
            renderInteractive: 'Un booléen qui indique si la demande de rendu actuelle utilise un format interactif.',
            renderFormatName: 'Le nom du moteur de rendu tel qu\'il est enregistré dans le fichier de configuration ReportServer.'
        },
        errorMessage: {
            emptyValue: 'La valeur ne peut pas être vide',
            invalidValue: 'n\'est pas une valeur valide'
        }
    },
    dataAssign: {
    ...
    reportProperty: {
        ...
        interactiveSize: {
            categoryName: 'Taille interactive',
            enable: 'Activer',
            width: 'Largeur',
            height: 'la taille'
        },
    ...
    textBoxProperty: {
        ...
        interActiveSort: {
            ...
            userSort: {
                labelText: 'Tri des expressions',
                scopePropertyLabel: 'Tri Expression Scope',
                targetPropertyLabel: 'Cible de tri'
            }
        },
        localization: {
    ...
    designPanel: {
        ...
        pasteTitle: 'Coller',
        headerAreaLabel: 'En-tête de zone de conception',
        bodyAreaLabel: 'Corps de la zone de conception',
        footerAreaLabel: 'Zone de conception',
        rdlSwitcherAlert: {
            headerContent: 'rapport',
            bodyContent: 'Le rapport est une mise à niveau vers la version inférieure de la version actuelle et certaines fonctionnalités ne sont pas prises en charge dans cette version. Voulez-vous continuer ?'
        }
    },
    designContextMenu: {
        cutItem: 'Couper',
    ...
    tablixProperty: {
        ...
        headers: {
            ...
            fixedRow: 'Ligne fixe',
            fixedColumn: 'Colonne fixe',
            repeatRow: 'Répéter les rangs',
            repeatColumn: 'Répéter la colonne'
        },
        font: {
            categoryName: 'Police de caractère',
            defaultStyle: 'Défaut',
    ...
    tablixContextMenu: {
        ...
        rowGroupMenu: {
            insideGroupAbove: 'À l\'intérieur du groupe - Ci-dessus',
            insideGroupBelow: 'À l\'intérieur du groupe - Ci-dessous',
        ...
        columnGroupMenu: {
            ...
            insideGroupRight: 'À l\'intérieur du groupe - Right',
    ...
    tablixTotalAlert: {
        headerLabel: 'Ajouter un en-tête total',
        staticLabel: 'Ajouter le total',
    ...
    queryDesigner: {
        ...
        schemaArea: {
            ...
            errorMessage: {
                ...
                confirmPermission: 'D\'énormes enregistrements récupérés, le rendu prendra du temps.Voulez - vous quand même charger?'
            },
        ...
        joiner: {
            ...
            errorMessage: {
                ...
                saveJoinerAlert: 'Impossible de joindre les tables sélectionnées'
            }
        },
        credentialDialog: {
            ...
            connect: 'Relier',
            close: 'Fermer',
            credentialLabel: 'Informations d\'identification de la source de données'
        },
        queryExpression: {
    ...
    codeDialog: {
        ...
        reference: {
            ...
            referenceSuffixToolTip: ' sur les références d\'assemblage RDL.'
        },
        classes: {
            title: 'Classes',
            nameFieldWaterMark: 'Nom de la classe',
            instanceFieldWaterMark: 'Nom de l\instance',
            emptyFieldValidation: 'Les champs sont vides',
            emptyInstanceValueValidation: 'Le champ est vide',
            headerText: 'Liste des instances de classe',
            toolTip: 'Ajoutez des instances de classe pour accéder à vos fonctions d\'objet dans le rapport.',
            toolTipSuffix: ' sur les classes RDL.'
        },
        code: {
            title: 'Code',
            headerText: 'Fonction de code VB pour le rapport',
            tooltip: 'Le moteur de génération de rapports {customBrandName} prend en charge les fonctions de code VB à intégrer aux éléments de rapport et aux données.',
            toolTipSuffix: ' sur le module de code RDL.'
        },
    ...
    parameterLayout: {
        title: 'Disposition des paramètres',
        ok: 'D\'accord',
        cancel: 'Annuler',
        closeToolTip: 'proche',
        deleteConfirmation: {
            title: 'Paramètre',
            deleteCell: 'Supprimer le paramètre de rapport',
            deleteCells: 'Supprimer les paramètres du rapport'
        }
    },
    ...
    commonProperty: {
        ...
        fontSettings: {
            categoryName: 'Paramètres de police',
            fontLabel: 'Police de caractère',
            fontStyleLabel: 'Font StyleLe style de police',
            fontFamily: 'Famille de polices',
            fontColor: 'Couleur de la police',
            fontSize: 'Taille de police',
            fontStyle: 'Le style de police',
    ...
    mapProperty: {
        ...
        commonProperties: {
            ...
            mapColorRule: {
                categoryName: 'Règle de couleur de forme',
                colorRuleEnable: 'Activer la règle de couleur',
                ...
                paletteTypes: {
                    ...
                    light: 'Lumière',
                    semiTransparent: 'Semi transparent',
                    brightPastel: 'Pastel brillant',
                    pacific: 'Pacifique'
                },
                customColors: 'Couleurs personnalisées',
                startColor: 'Couleur de départ',
                middleColor: 'Couleur du milieu',
                endColor: 'Couleur de fin',
                legendName: 'Nom de la légende',
                legendText: 'Texte de la légende',
                showInColorScale: 'Afficher dans une échelle de couleurs'
            },
            position: {
                topLeft: 'En haut à gauche',
                topCenter: 'Centre supérieur',
        ...
        mapTitle: {
            ...
            position: 'Position',
            text: 'Texte',
            enableTitle: 'Activer le titre'
        },
        basicSettings: {
            categoryName: 'Paramètres de base',
            polygonLayerName: 'Nom de la couche de polygone',
            shapeType: 'Formes',
            datasetName: 'Ensemble de données',
            bindData: 'Données de liaison',
            mapProjection: {
        ...
        legendSettings: {
            categoryLegend: 'Légende',
            showLegend: 'Activer la légende',
            showBorder: 'Afficher la bordure',
            border: 'Frontière',
            ...
            legendFont: 'Police de caractère',
            legendFontStyle: 'Le style de police',
            legendTitle: 'Titre',
            titleFont: 'Police de titre',
            titleFontStyle: 'Style de police du titre',
        },
        ...
        polygonTemplate: {
            categoryName: 'Paramètres de forme',
        ...
        fontcolortooltip: 'Couleur',
        fontsizetooltip: 'Taille',
        fontstyletooltip: 'Le style de police',
        miscellaneous: {
        ...
        spatial: {
            ...
            polygons: 'Des polygones'
        },
        mapErrorMessage: {
            headerText: 'Carte',
            polygonErrorMessage: 'Impossible de convertir le geojson avec les polygones mis à jour.',
            vectorDataToGeoJson: 'Échec de la récupération du geojson à partir des données vectorielles',
            shapeData: 'Données de forme de carte non configurées dans le concepteur',
            shapeDateToGeoJson: 'Échec de la récupération du geojson à partir des données de forme',
            multiLayer: 'La carte ne prend pas en charge plusieurs couches dans le concepteur',
            polygonLayer: 'La carte ne prend en charge que la couche de polygones dans le concepteur',
            fileTypes: 'La carte ne prend en charge que les types de fichiers de formes et incorporés dans le concepteur',
            unSupported: 'La carte n\'est pas prise en charge dans le concepteur'
        },
        mapMarker: {
            colorRule: 'Règle de couleur de marqueur',
            markerRule: 'Règle de marqueur',
            enableMarkerRule: 'Activer la règle de marqueur',
            enableSizeRule: 'Activer la règle de taille',
            sizeRule: {
                categoryName: 'Règle de taille de marqueur',
                startSize: 'Taille de départ',
                endSize: 'Taille de fin',
                markers: 'Marqueuses'
            },
            markerTemplate: {
                categoryName: 'Paramètres des marqueurs',
                showMarker: 'Activer le marqueur',
                background: 'Contexte',
                markerStyle: 'Style',
                markerSize: 'Taille',
                tooltip: 'Info-bulle',
    ...
    mapBindingFields: {
        ...
        bindingExpression: 'Expression contraignante',
        deletefield: 'Supprimer le champ',
        errorMessage: {
            bindingExpError: 'Choisissez la valeur pour l\'expression de liaison',
            fieldNameError: 'Choisissez une valeur pour le nom du champ',
            warningMessage: 'Les modifications que vous avez apportées peuvent ne pas être mises à jour.Voulez - vous toujours continuer ?'
        }
    },
    mapBucket: {
        headerText: 'Seau de cartes',
        addText: 'AJOUTER',
        updateText: 'Mise à jour',
        startValue: 'Valeur de départ',
        endValue: 'Valeur finale',
    ...
    mapPolygons: {
        headerText: 'Des polygones',
        addText: 'AJOUTER',
        polygonText: 'Polygone de carte',
        updateText: 'Mise à jour',
        editPolygon: 'Éditer',
        deletePolygon: 'Supprimer le polygone',
        properties: 'Propriétés du polygone',
        closeText: 'Fermer',
        saveText: 'Sauvegarder',
        data: 'Les données',
        spatial: 'Spatiale',
        vectorData: 'Données vectorielles',
        errorMessage: {
            warningMessage: 'Les modifications que vous avez apportées peuvent ne pas être mises à jour.Voulez - vous toujours continuer ?'
        }
    },
    mapMarkerStyle: {
        headerText: 'Marqueur de carte',
        updateText: 'Mise à jour',
        add: 'AJOUTER',
        label: 'Style de marqueur',
        deletefield: 'Supprimer',
        errorMessage: 'Les modifications que vous avez apportées peuvent ne pas être mises à jour.Voulez - vous toujours continuer ?',
        styles: {
            circle: 'Cercle',
            none: 'Aucun',
            rectangle: 'Rectangle',
    ...
    mapFieldDefinition: {
        mapFieldTitle: 'Définitions des champs de carte',
        fieldName: 'Nom de domaine',
        dataType: 'Type de données',
        mapAlertMessage: 'Les modifications que vous avez apportées peuvent ne pas être enregistrées. Voulez-vous toujours continuer?',
        addText: 'AJOUTER',
        errorMessage: {
            errorEmptyMessage: 'Indiquez le nom du champ',
            sameCharacterMessage: 'Le nom de champ existe déjà'
        },
        updateText: 'MISE À JOUR'
    },
    mapCustomColors: {
        headerText: 'Couleurs personnalisées',
        updateText: 'Mise à jour',
        add: 'AJOUTER',
        label: 'Couleur',
        deletefield: 'Supprimer',
    ...
    reportVariable: {
        ...
        value: 'Valeur',
        deletefield: 'Supprimer',
        checkBoxTooltip: 'Lecture seulement',
        errorMessage: {
            warningMessage: 'Les modifications que vous avez apportées peuvent ne pas être mises à jour.Voulez - vous toujours continuer ?',
            emptyAlert: 'Le nom ne peut pas être vide',
            duplicateName: 'Le nom existe déjà',
            specialCharacter: 'Le nom ne doit pas contenir d\'espaces et de caractères spéciaux'
        }
    },
    indicatorStates: {
        headerText: 'États indicateurs',
        addText: 'AJOUTER',
        updateText: 'Mettre à jour',
        deletefield: 'Supprimer le champ',
        indicatorStyle: 'Icône',
        color: 'Couleur',
        start: 'Début',
        end: 'Fin',
        scaleFactor: 'Facteur d\'échelle',
        indicatorStateValue: 'Valeur de l\'état de l\'indicateur',
        errorMessage: {
            warningMessage: 'Les modifications que vous avez apportées peuvent ne pas être mises à jour. Voulez-vous continuer?'
        }
    },
    webDataExpression: {
        ...
        password: 'Mot de passe',
        valueWaterMark: 'Valeur',
        emptyValue: 'Spécifiez la valeur de l\'expression'
    }
};
