ej.ReportDesigner.Locale['en-US'] = {
    ...
    reportViewer: {
        ...
        findAlertMessage: {
            resultsEndReached: 'You have reached the end of the search results. If you wish to continue, '
                + 'then close the dialog box and search again.',
            noResultsFound: 'The specified text does not match any of the contents in the report. '
                + 'Change your search keyword and try again.'
        },
        credential: {
            userName: 'Username',
            password: 'Password'
